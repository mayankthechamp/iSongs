...
public class PlayerActivity extends AppCompatActivity {
    ...
    private java.util.ArrayList<File> ArrayList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActionBar actionBar = getSupportActionBar(); // Get the ActionBar object
        if (actionBar != null) {
            actionBar.setTitle("Now Playing"); // Set the title if the ActionBar is not null
